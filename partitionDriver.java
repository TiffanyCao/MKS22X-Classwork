    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            try {
                ...
                int index = Partition.partition(test, start, end);
